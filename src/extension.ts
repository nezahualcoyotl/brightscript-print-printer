...
function printFunctionsAndParameters() {
	applyTextTransformation(text => appendParameters(appendFunctionNames(text)));
}
...
function printAll() {
	applyTextTransformation(text => appendReturns(appendParameters(appendFunctionNames(text))));
}
...
export function activate(context: vscode.ExtensionContext) {
	...
	context.subscriptions.push(
		vscode.commands.registerCommand('brightscript-print-printer.printFunctions', printFunctions),
		vscode.commands.registerCommand('brightscript-print-printer.printParameters', printParameters),
		vscode.commands.registerCommand('brightscript-print-printer.printReturn', printReturn),
		vscode.commands.registerCommand('brightscript-print-printer.printFunctionsAndParameters', printFunctionsAndParameters),
		vscode.commands.registerCommand('brightscript-print-printer.printFunctionsAndReturn', printFunctionsAndReturn),
		vscode.commands.registerCommand('brightscript-print-printer.printAll', printAll)
	);
}
